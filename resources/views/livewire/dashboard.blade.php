                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <p class="font-bold text-3xl">{{ $totalCensoSucre }}<span class="text-green-500"><i
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <p class="font-bold text-3xl">{{ $totalAprobado }}<span class="text-pink-500"><i
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <p class="font-bold text-3xl">{{ $totalCensoWO }}</p>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
