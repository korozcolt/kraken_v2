<div wire:init="loadSupervisor">
    ...
    <div class="py-12">
        ...
        <x-jet-dialog-modal wire:model="open_edit">
            <x-slot name="title">
                Edita un registro de Supervisor {{ $supervisor->firstname }} {{ $supervisor->lastname }}
            </x-slot>
            <x-slot name="content">
                <div class="mb-4">
                    <x-jet-label value="Nombre" class="text-left"></x-jet-label>
                    <x-jet-input type="text" class="w-full" wire:model="supervisor.firstname"></x-jet-input>
                </div>
                <div class="mb-4">
                    <x-jet-label value="Apellido" class="text-left"></x-jet-label>
                    <x-jet-input type="text" class="w-full" wire:model="supervisor.lastname"></x-jet-input>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="date" class="w-full" wire:model="supervisor.brithdate"></x-jet-input>
