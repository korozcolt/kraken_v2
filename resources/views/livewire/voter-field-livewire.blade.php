                                        ...
                                        @foreach($voters as $value)
                                            <tr class="text-gray-700">
                                                ...
                                                <td class="px-4 py-3 text-xs border text-center">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm text-center"> {{ $value->place }} </span>
                                                </td>
                                                <td class="px-4 py-3 text-xs border text-center">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm text-center"> {{ $value->table }} </span>
                                                </td>
                                                <td class="px-4 py-3 text-xs border text-center">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm text-center"> 70{{ $value->city_id }} </span>
                                                </td>
                                                <td class="px-4 py-3 text-xs border text-center flex">
                                                    <a href="#" class="text-gray-400 hover:text-gray-100 ml-2" wire:click="edit({{ $value->id }})">
            ...
            <x-slot name="content">
               <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select wire:model="voter.city_id" class="form-select appearance-none
                    block
                    w-full
                    px-3
                    py-1.5
