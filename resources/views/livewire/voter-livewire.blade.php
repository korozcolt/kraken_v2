        ...
        <x-jet-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" class="w-full" wire:model="voter.phone_two"></x-jet-input>
                </div>
                <div class="mb-4">
                    <x-jet-label value="Dirección" class="text-left"></x-jet-label>
                    <x-jet-input type="text" class="w-full" wire:model="voter.address"></x-jet-input>
                </div>
                <div class="mb-4">
                    <x-jet-label value="Sexo" class="text-left"></x-jet-label>
                    <select wire:model="voter.gender" class="w-full" name="gender" id="gender">
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="date" class="w-full" wire:model="voter.brithdate"></x-jet-input>
