...
@section('content-votation')
    <div class="vh-100 d-flex justify-content-center align-items-center">
        <div class="row m-4">
            ...
            <form action="{{ route('votaciones.consultaDni') }}" method="post" class="form col-md-12 m-4">
                {{ csrf_field() }}
                ...
                <div class="text-center m-4">
                    <button type="submit" class="btn btn-primary btn-lg btn-block m-2">CONSULTAR</button>
                </div>
            </form>
        </div>
    </div>
