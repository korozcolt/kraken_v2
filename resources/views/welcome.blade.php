...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('favicon-16x16.png') }}" rel="icon" />
    ...
    <link
      href="{{ asset('welcome/assets/vendor/bootstrap/css/bootstrap.min.css') }}"
      rel="stylesheet"
    />
    <link
      href="{{ asset('welcome/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}"
      rel="stylesheet"
    />
    <link href="{{ asset('welcome/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet" />
    <link
      href="{{ asset('welcome/assets/vendor/boxicons/css/boxicons.min.css') }}"
      rel="stylesheet"
    />
  ...
  <body>
      ...
      >
        <div class="row justify-content-center">
          <div class="col-xl-7 col-lg-9 text-center">
            <h1>KRAKEN SOFTWARE</h1>
            <h2>...Software for voters...</h2>
          </div>
        </div>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('welcome/assets/vendor/purecounter/purecounter.js') }}"></script>
